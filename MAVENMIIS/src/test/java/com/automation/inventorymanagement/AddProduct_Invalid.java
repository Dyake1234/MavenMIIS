...
public class AddProduct_Invalid extends TestBase{

	
private static Logger Log = LogManager.getLogger(AddProduct_Invalid.class.getName());
...
public void AddingProduct_ValidEntry() throws InterruptedException  {
	...
	Pages.inventoryPage().clickSave();
	Assert.assertEquals(Pages.inventoryPage().validatePrompt(), "Location is required");
